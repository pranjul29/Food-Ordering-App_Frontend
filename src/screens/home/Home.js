...
class Home extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Header baseUrl={this.props.baseUrl} showHeaderSearchField={true} filterRestaurantBySearchHandler={this.filterRestaurantBySearchHandler}/>
                        ...
                        {this.state.restaurant !== null ? this.state.restaurant.map(currentRestaurant => (
                            <Grid key={currentRestaurant.id} item xs={12} sm={6} md={3} className={classes.restaurantGridCard}>
                                <Card className={classes.restaurantCard}>
                                    <CardActionArea className={classes.restaurantCardContentArea} onClick={() => this.restaurantCardClickHandler(currentRestaurant.id)}>
                                        <CardMedia
                                        ...
                                        <CardContent className={classes.restaurantCardContent}>
                                            <div className="card-footer">
                                                <span className="restaurantRating">
                                                    ...
                                                    <Typography variant="caption" component="p" >{currentRestaurant.customer_rating}</Typography>
                                                    <Typography variant="caption" component="p" >({currentRestaurant.number_customers_rated})</Typography>
                                                </span>
