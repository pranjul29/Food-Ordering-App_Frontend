    ...
    render() {
        ...
        return (
            <div>
                ...
                {this.redirectToHome()}
                <Header baseUrl={this.props.baseUrl} showHeaderSearchField={false} logoutAndRedirectToHome={this.logoutAndRedirectToHome}/>
                                    ...
                                    <StepContent>
                                        {index === 0 ?
                                            <div className="address-container">
                                                <Tabs className="existing-new-address-tabs" value={this.state.value} onChange={this.tabChangeHandler}>
                                                                ...
                                                                {this.state.addresses.map(address => (
                                                                    <GridListTile className={classes.gridListTile} key={address.id} style={{ borderColor: address.selected ? "rgb(224,37,96)" : "white" }}>
                                                                        <div className="tile-grid-list-container">
                                                                            ...
                                                                            <IconButton style={{float:"right"}} className="address-check-button" onClick={() => this.addressSelectedHandler(address.id)}>
                                                ...
                                                {this.state.value === 1 &&
                                                    <TabContainer className={classes.newAddressForm}>
                                                        ...
                                                        <br />
                                                        <br />
                                                        <Button variant="contained" style={{fontWeight:"400",width:"150px"}} className="form-button" color="secondary" onClick={this.saveAddressHandler}>SAVE ADDRESS</Button>
                                                    </TabContainer>
                                                }
                                            </div>
                                            :
                        ...
                        <Card className={classes.summary}>
                            ...
                            <CardContent
                              ...
                              >
                                ...
                                <Typography variant='subtitle1' component='p' style={{fontSize:"18px",color:"rgb(85,85,85)",margin:"10px 0px"}} className="restaurant-name">{this.state.restaurantDetails.name}</Typography>
                                {this.state.cartItems.map(cartItem => (
                                    <div className="menu-item-container" key={cartItem.id}>
                                        ...
                                        <Typography variant="subtitle1" component="p" style={{marginLeft:"10px",color:"grey"}} className="menu-item-name" id="summary-menu-item-name" >{cartItem.name[0].toUpperCase() + cartItem.name.slice(1)}</Typography>
                                        <Typography variant="subtitle1" component="p" style={{marginLeft:"auto",marginRight:"30px",color:"grey"}} className="item-quantity">{cartItem.quantity}</Typography>
                                ...
                                <div className="discount-coupon-container">
                                    ...
                                    <Button variant="contained" color="default" style={{height:"40px"}} className="apply-button" onClick={this.applyButtonHandler} size="small">APPLY</Button>
                                </div>
                                <div className="amount-label-container">
                                    <Typography variant="subtitle2" component="p" style={{ color: 'grey' }}>Sub Total</Typography>
                                    <div className="total-amount">
                                        <i className="fa fa-inr" aria-hidden="true" style={{color: 'grey'}}/>
                                        <Typography variant="subtitle1" component="p" style={{ color: 'grey' }} id="summary-net-amount">{this.getItemTotal().toFixed(2)}</Typography>
                                    </div>
                                </div>
                                <div className="amount-label-container">
                                    ...
                                    <div className="total-amount">
                                        <i className="fa fa-inr" aria-hidden="true" style={{color: 'grey'}}/>
                                        <Typography variant="subtitle1" component="p" style={{ color: 'grey' }} id="summary-net-amount">{this.getDiscountedAmount().toFixed(2)}</Typography>
                                    </div>
                                </div>
                                ...
                                <div className="amount-label-container">
                                    ...
                                    <div className="total-amount">
                                        <i className="fa fa-inr" aria-hidden="true" style={{color: 'grey'}}/>
                                        <Typography variant="subtitle1" component="p" className={classes.itemPrice} id="summary-net-amount">{this.getNetTotal().toFixed(2)}</Typography>
                                    </div>
                                </div>

                                <Button variant="contained" color='primary' fullWidth={true} style={{fontWeight:"400"}} className="place-order-button" onClick={this.placeOrderButtonHandler}>PLACE ORDER</Button>
